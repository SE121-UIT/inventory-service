...
export const loadCheckPointPostgre = async (subscriptionId: string) => {
...
export const storeCheckpointPostgre =
  (handle: EventHandler) => async (event: SubscriptionResolvedEvent) => {
    await handle(event);
...
export const SubscriptionToAllWithPostgreCheckpoints = SubscriptionToAll(
  getEventStore(),
  loadCheckPointPostgre
);
